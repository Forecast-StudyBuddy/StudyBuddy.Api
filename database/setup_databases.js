...
con.query("CREATE DATABASE study_buddy_db", function (err, result) {
    ...
    // create USERS table
    let user_table_sql = 'CREATE TABLE users (name VARCHAR(255), id VARCHAR(255) PRIMARY KEY, password VARCHAR(255))'
    ...
    let courses_table_sql = 'CREATE TABLE courses (course_name VARCHAR(255), id VARCHAR(255) PRIMARY KEY)'
